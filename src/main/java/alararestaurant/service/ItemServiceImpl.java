...
public class ItemServiceImpl implements ItemService {
    ...
    private final static String ITEM_JSON_FILE_PATH = "D:\\SoftUni\\Hibernate - June 2019\\AlaraRestaurant\\src\\main\\resources\\files\\items.json";
    ...
    @Autowired
    public ItemServiceImpl(ItemRepository itemRepository, CategoryRepository categoryRepository, FileUtil fileUtil,
